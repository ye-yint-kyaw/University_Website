                ...
                <div className="flex justify-between items-center py-8 px-2 sm:px-15">
                    ...
                    <div className="flex">
                        <div className="relative w-full mx-3 max-w-md">
                            ...
                            className="hidden sm:block w-full pl-12 pr-4 py-2 rounded-2xl shadow-lg bg-white text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300"
                            />
